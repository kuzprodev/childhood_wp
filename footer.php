...
<div class="reply">
    <div class="reply__body">
        ...
        <?php echo do_shortcode('[contact-form-7 id="170" title="форма с вопросом"]'); ?>
    </div>
</div>
<footer>
    <div class="container">
            ...
            <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                <div class="footer__contacts">
                    ...
                    <div class="footer__contacts-item">
                        ...
                        <address><?php the_field('geo', 2); ?></address>
                    </div>
                </div>
            </div>
        </div>
...
wp_footer();
?>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCGMSUGZtEB7eFFiNZ13kTAxGWsS5z8zUM"></script>
