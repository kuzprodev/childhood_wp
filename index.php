    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <!-- <img class="specialists__img" src="<?php the_field('team_image'); ?>" alt="наша команда"> -->
                <?php
                // <!-- это картинка через массив изображения -->
                $image = get_field('team_image');

                if (!empty($image)) : ?>
                    <img src="<?php echo $image['url'] ?>" class="specialists__img" alt="<?php echo $image['alt'] ?>">
                <?php endif;
                // print_r($image);
                ?>
            </div>
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="toys__alert">
                    <span><?php the_field('toys_action_question'); ?></span> <?php the_field('toys_action_text'); ?>
                </div>
            </div>
        </div>
    </div>
...
<div class="contacts" id="contacts">
    <h1 class="title"><?php the_field('geo_title'); ?></h1>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="title contacts__minititle"><?php the_field('geo_title_left'); ?></div>
            ...
            <div class="col-md-6">
                <div class="title contacts__minititle"><?php the_field('geo_title_right'); ?></div>
